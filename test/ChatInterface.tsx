      ...
      >
        ...
        <div
          ...
          style={{
            ...
            width: '100%',
            maxWidth: '1100px',
            height: state.messages.length === 0 ? '100vh' : 'calc(100vh - 140px)',
            overflowY: state.messages.length === 0 ? 'hidden' : 'auto',
            overflowX: 'hidden',
            paddingLeft: '32px',
            paddingRight: '32px',
            paddingTop: '0px',
        ...
        >
          ...
          {state.messages.length === 0 && (
            <div style={{
              ...
              <div style={{ width: '100%', maxWidth: 'min(700px, 90vw)', position: 'relative', zIndex: 1 }}>
                <InputArea />
